...
public class BoardController {
	...
	public void getLlstSearch(
		 ...
		 List<BoardVO> list = service.listSearch(scri);  //게시글 리스트 가져오기
		 model.addAttribute("list", list);
		 
		 System.out.println(list.toString());

		 PageMaker pageMaker = new PageMaker();  //pageMaker 정보 생성
		 pageMaker.setCri(scri);   //page와 perPageNum 정보 입력
		 pageMaker.setTotalCnt(service.searchCnt(scri));  //게시글 갯수 계산
	...
	public String postWirte( BoardVO vo ) throws Exception  {
		log.info("BoardController:: postWirte invoke");
		service.write(vo);
	...
	public void getDetail(
		...
		log.info("BoardController:: getDetail invoke");
	...
	public void getModify (
			...
			Model model) throws Exception {
		log.info("BoardController:: getModify invoke");
	...
	public String postModify(BoardVO vo,  @ModelAttribute("scri") SearchCriteria scri, RedirectAttributes rttr) 
			throws Exception {
		log.info("BoardController:: postModify invoke");
	...
	public String getDelete(
		...
		log.info("BoardController:: getDelete invoke");
